...
function renderItem(array){
    if (array.length != 0){
        ...
        for (let i = 0; i < array.length; i++){
            ...
            output += 
                `<a class="item page-${index + 1}" href="productitem.html" target="_blank" data-id="${array[i].id}" data-group="${array[i].group}" onclick="sendData(this)" >
...
//Part 10 : Funtion for Scrolling Button
