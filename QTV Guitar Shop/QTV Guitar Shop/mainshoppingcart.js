                        ...
                        <div class="shopping-cart-item-detail">
                            <div class="item-detail">
                                ...
                                <div class="item-detail-info">
                                    <a class="item-name" onclick="sendData(this)" href="productitem.html" data-id="${shoppingCart[i].id}" data-group="${shoppingCart[i].group}">${shoppingCart[i].name}</a>
                            ...
                            <div class="item-quantity">
                                <div class="item-number" data-id="${shoppingCart[i].id}" data-group="${shoppingCart[i].group}">
...
function deleteItem(elt){//delete Item
    idDelete = elt.parentNode.children[0].dataset.id;
    for (let i = 0; i < shoppingCart.length; i++){
        if (shoppingCart[i].id === idDelete){
...
function plusItem(elt){  // Plus Number item
    ...
    currentValue += 1;
    document.querySelector('#item-quantity').value = `${currentValue}`; 
    let idItem = elt.parentNode.dataset.id;
    for (let i = 0; i < shoppingCart.length; i++){
        if (shoppingCart[i].id === idItem){
            shoppingCart[i].count = parseInt(elt.parentNode.childNodes[1].value);
